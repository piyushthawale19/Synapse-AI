  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          {/* Logo image removed per request. If you want a visible placeholder, replace this span with an inline SVG or icon component. */}
          <span className="sr-only">CuraLink</span>
        </Button>
      </DropdownMenuTrigger>
